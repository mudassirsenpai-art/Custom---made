...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "'paddleocr-classic' (PP-OCRv4, not the VLM) is a "
            "multi-language (Japanese/Korean/Chinese/English) CPU-friendly option."
        ),
    )
    # Rendering args
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        choices=["flux_klein_9b", "flux_klein_4b", "flux_kontext", "lama", "opencv", "none"],
